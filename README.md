...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/VARSHAN69/flappy-bird-canvas.git
   cd flappy-bird-canvas
   ```
...
[![Repo](https://img.shields.io/badge/flappy-bird-canvas-Repo-00CC66?style=for-the-badge&logo=github&logoColor=black)](https://github.com/VarshuAi/flappy-bird-canvas)
